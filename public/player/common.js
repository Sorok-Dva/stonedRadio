var playerFavoriteImage = 'images/player1.png';
var playerUnfavoriteImage = 'images/player2.png';
...
function ShowPreroll() {
	if (($.cookie("ad-preroll") == null || $.cookie("ad-preroll") == 0) && language.match(/fr/i)) {
		...
		$('#player .rad-adsBanner').append('<iframe width="728" height="90" scrolling="no" style="border:0; padding:10px" src="/' + language + '/ad/siteplayer"></iframe>');
		$('#player .rad-adsBanner').show();
